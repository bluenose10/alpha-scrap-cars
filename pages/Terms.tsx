          ...
          <div className="rounded-3xl border-2 border-brand-red-600/30 bg-white/90 p-10 shadow-xl shadow-gray-200/70">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">By accessing and using Alpha Recovery's vehicle breakdown recovery services, you accept and agree to be bound by the terms and provision of this agreement.</p>
              </div>

              <div>
                <h2 className="text-2xl font-bold text-brand-darker mb-4">2. Use License</h2>
                <p className="text-gray-600 leading-relaxed">Permission is granted to temporarily access the materials on Alpha Recovery's website for personal, non-commercial transitory viewing only.</p>
              </div>

              <div>
                <h2 className="text-2xl font-bold text-brand-darker mb-4">3. Disclaimer</h2>
                <p className="text-gray-600 leading-relaxed">The materials on Alpha Recovery's website are provided on an 'as is' basis. Alpha Recovery makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.</p>
              </div>

              <div>
                <h2 className="text-2xl font-bold text-brand-darker mb-4">4. Limitations</h2>
                <p className="text-gray-600 leading-relaxed">In no event shall Alpha Recovery or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Alpha Recovery's website.</p>
              </div>

              <div>
                <h2 className="text-2xl font-bold text-brand-darker mb-4">5. Revisions</h2>
                <p className="text-gray-600 leading-relaxed">The materials appearing on Alpha Recovery's website could include technical, typographical, or photographic errors. Alpha Recovery does not warrant that any of the materials on its website are accurate, complete, or current.</p>
              </div>

              <div>
                <h2 className="text-2xl font-bold text-brand-darker mb-4">6. Links</h2>
                <p className="text-gray-600 leading-relaxed">Alpha Recovery has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site.</p>
              </div>

              <div>
                <h2 className="text-2xl font-bold text-brand-darker mb-4">7. Modifications</h2>
                <p className="text-gray-600 leading-relaxed">Alpha Recovery may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.</p>
              </div>
