  ...
  <textarea name="message"></textarea>
                        ...
                        <form name="contact" method="POST" data-netlify="true" onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="message" id="message" rows={4} required value={formData.message} onChange={handleChange} className={inputStyles} placeholder="Tell us how we can help..."></textarea>
                            </div>
                            <div>
                         ...
                         <ul className="space-y-5">
                            <li className="flex items-start rounded-2xl border-2 border-brand-red-600/30/70 p-4 bg-gray-50/80">
                             ...
                             <li className="flex items-start rounded-2xl border-2 border-brand-red-600/30/70 p-4 bg-gray-50/80">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:info@alpharecovery.co.uk" className="text-brand-red-600 hover:text-brand-red-700">info@alpharecovery.co.uk</a>
                            ...
                            <li className="flex items-start rounded-2xl border-2 border-brand-red-600/30/70 p-4 bg-gray-50/80">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Southport, Merseyside, UK</p>
